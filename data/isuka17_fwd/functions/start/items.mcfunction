...
give @a[scores={fwd_itemnumber=7}] potion{display:{Name:'{"text":"千里馬の薬","color":"aqua","italic":false}',Lore:['{"text":"30秒間、移動速度が大幅に上昇する。","color":"white","italic":false}']},CustomPotionEffects:[{Id:1,Duration:600,Amplifier:4}],CustomPotionColor:36095,HideFlags:255} 1
