...
execute if score #会議時間 fwd_settings matches 0 run give @a[tag=meeting_join] arrow{display:{Name:'{"text":"人狼用矢","color":"red","italic":false}'},HideFlags:1,Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]} 1
