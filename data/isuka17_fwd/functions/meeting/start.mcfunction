...
execute store result score #会議参加人数 fwd_settings if entity @a[distance=..5]

execute if score #会議参加人数 fwd_settings matches 3.. run tag @a[distance=..5,limit=3,sort=nearest] add meeting_join
